...
Evolute is an AI-powered screen companion for Windows. It captures your screen, listens to your voice, and uses Claude to answer questions about what you're looking at - pointing directly at UI elements in its responses.
...
When you first open Evolute, you'll see a chat window with an API key setup panel.
...
Evolute will capture a screenshot of your display, send it to Claude along with your question, and stream back a response.
...
Without AssemblyAI, you can still type questions. Without ElevenLabs, Evolute falls back to Windows' built-in speech (SAPI) - functional but robotic.

## System Tray

Evolute runs as a tray app. Right-click the gem icon for:
...
1. Evolute captures a screenshot of all your monitors
