...
**Symptom:** Nothing happens when you launch Evolute, or it crashes immediately.
...
- Go to **Settings > Personalization > Taskbar > Other system tray icons** and enable Evolute
...
- The screenshot may be too large - this shouldn't happen normally as Evolute caps images at 1280px
...
- Make sure Evolute has screen capture permissions (usually auto-granted on Windows)
...
- Try running Evolute as administrator if the global hotkey isn't registering
...
- Try restarting Evolute

## High Memory Usage

**Symptom:** Evolute is using a lot of RAM.
